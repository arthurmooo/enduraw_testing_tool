...
def _metasoft_xml(
    ...
    headers = [
        ...
        "V'E", "VT", "V'E/V'O2", "V'E/V'CO2", "PetO2", "PetCO2", "BF", "N", "v", "DE",
    ]
    units = [
...
class MetaSoftLocalCoreTest(unittest.TestCase):
    ...
    def test_parse_analysis_and_export_use_normalised_metasoft_points(self) -> None:
        ...
        self.assertEqual(analysis["metrics"]["grade_percent"]["unit"], "%")
        self.assertEqual(analysis["points"][2]["values"]["grade_percent"], 1)
